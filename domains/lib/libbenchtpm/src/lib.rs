...
pub fn test_tpm(tpm: &dyn UsrTpm) {
    ...
    tpm.tpm_pcr_read(locality, pcr_idx, TpmAlgorithms::TPM_ALG_SHA256 as u16, &mut pcr_size, &mut pcr);
    ...
    tpm.tpm_create_primary(locality, None, primary_unique,
    ...
    let nonce = alloc::vec![0; 32];
    tpm.tpm_start_auth_session(locality, TpmSE::TPM_SE_POLICY,
    ...
    tpm.tpm_create_primary(locality, None, aik_unique,
    ...
    tpm.tpm_quote(locality, aik_handle, TpmAlgorithms::TPM_ALG_SHA256 as u16,
