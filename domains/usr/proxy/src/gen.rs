...
impl proxy::Proxy for Proxy {
    ...
    fn as_create_pci(&self) -> Arc<dyn interface::domain_create::CreatePCI> {
        Arc::new(self.clone())
    }
    fn as_create_ahci(&self) -> Arc<dyn interface::domain_create::CreateAHCI> {
        Arc::new(self.clone())
    }
    fn as_create_membdev(&self) -> Arc<dyn interface::domain_create::CreateMemBDev> {
        Arc::new(self.clone())
    }
    fn as_create_bdev_shadow(&self) -> Arc<dyn interface::domain_create::CreateBDevShadow> {
        Arc::new(self.clone())
    }
    fn as_create_ixgbe(&self) -> Arc<dyn interface::domain_create::CreateIxgbe> {
        Arc::new(self.clone())
    }
    fn as_create_net_shadow(&self) -> Arc<dyn interface::domain_create::CreateNetShadow> {
        Arc::new(self.clone())
    }
    fn as_create_nvme_shadow(&self) -> Arc<dyn interface::domain_create::CreateNvmeShadow> {
        Arc::new(self.clone())
    }
    fn as_create_benchnet(&self) -> Arc<dyn interface::domain_create::CreateBenchnet> {
        Arc::new(self.clone())
    }
    fn as_create_benchnvme(&self) -> Arc<dyn interface::domain_create::CreateBenchnvme> {
        Arc::new(self.clone())
    }
    fn as_create_nvme(&self) -> Arc<dyn interface::domain_create::CreateNvme> {
        Arc::new(self.clone())
    }
    fn as_create_xv6fs(&self) -> Arc<dyn interface::domain_create::CreateRv6FS> {
        Arc::new(self.clone())
    }
    fn as_create_xv6net(&self) -> Arc<dyn interface::domain_create::CreateRv6Net> {
        Arc::new(self.clone())
    }
    fn as_create_xv6net_shadow(&self) -> Arc<dyn interface::domain_create::CreateRv6NetShadow> {
        Arc::new(self.clone())
    }
    fn as_create_xv6usr(&self) -> Arc<dyn interface::domain_create::CreateRv6Usr + Send + Sync> {
        Arc::new(self.clone())
    }
    fn as_create_xv6(&self) -> Arc<dyn interface::domain_create::CreateRv6> {
        Arc::new(self.clone())
    }
    fn as_create_dom_a(&self) -> Arc<dyn interface::domain_create::CreateDomA> {
        Arc::new(self.clone())
    }
    fn as_create_dom_b(&self) -> Arc<dyn interface::domain_create::CreateDomB> {
        Arc::new(self.clone())
    }
    fn as_create_dom_c(&self) -> Arc<dyn interface::domain_create::CreateDomC> {
        Arc::new(self.clone())
    }
    fn as_create_dom_d(&self) -> Arc<dyn interface::domain_create::CreateDomD> {
        Arc::new(self.clone())
    }
    fn as_create_shadow(&self) -> Arc<dyn interface::domain_create::CreateShadow> {
        Arc::new(self.clone())
    }
}

impl interface::domain_create::CreatePCI for Proxy {
    fn create_domain_pci(&self) -> (Box<dyn Domain>, Box<dyn PCI>) {
        self.create_pci.create_domain_pci()
    }
}

impl interface::domain_create::CreateAHCI for Proxy {
...
impl interface::domain_create::CreateMemBDev for Proxy {
...
impl interface::domain_create::CreateBDevShadow for Proxy {
    fn create_domain_bdev_shadow(
        &self,
        create: Arc<dyn interface::domain_create::CreateMemBDev>,
    ) -> (Box<dyn Domain>, Box<dyn BDev>) {
...
impl interface::domain_create::CreateIxgbe for Proxy {
...
impl interface::domain_create::CreateNetShadow for Proxy {
    fn create_domain_net_shadow(
        &self,
        create: Arc<dyn interface::domain_create::CreateIxgbe>,
        pci: Box<dyn PCI>,
...
impl interface::domain_create::CreateNvmeShadow for Proxy {
    fn create_domain_nvme_shadow(
        &self,
        create: Arc<dyn interface::domain_create::CreateNvme>,
        pci: Box<dyn PCI>,
...
impl interface::domain_create::CreateNvme for Proxy {
...
impl interface::domain_create::CreateRv6FS for Proxy {
...
impl interface::domain_create::CreateRv6Net for Proxy {
...
impl interface::domain_create::CreateRv6NetShadow for Proxy {
    fn create_domain_xv6net_shadow(
        &self,
        create: Arc<dyn interface::domain_create::CreateRv6Net>,
        net: Box<dyn Net>,
...
impl interface::domain_create::CreateRv6Usr for Proxy {
...
impl interface::domain_create::CreateRv6 for Proxy {
...
impl interface::domain_create::CreateDomA for Proxy {
