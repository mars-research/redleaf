...
use idt::{HandlerFunc, InterruptDescriptorTable, PtRegs};
...
#[no_mangle]
extern "C" fn do_divide_error(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 1: Debug
#[no_mangle]
extern "C" fn do_debug(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
    println!("Debug exception:\n{:#?}", pt_regs);
    crate::panic::backtrace_exception(pt_regs);
    crate::halt();
...
// 2: NMI
#[no_mangle]
extern "C" fn do_nmi(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 3: Breakpoint
#[no_mangle]
extern "C" fn do_int3(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 4: Overflow
#[no_mangle]
extern "C" fn do_overflow(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 5: Bound range
#[no_mangle]
extern "C" fn do_bounds(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 6: Invalid opcode
#[no_mangle]
extern "C" fn do_invalid_op(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn do_device_not_available(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 8: Double fault
#[no_mangle]
extern "C" fn do_double_fault(pt_regs: &mut PtRegs, error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn do_coprocessor_segment_overrun(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 10: Invalid TSS
#[no_mangle]
extern "C" fn do_invalid_TSS(pt_regs: &mut PtRegs, error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn do_segment_not_present(pt_regs: &mut PtRegs, error_code: isize) {
    unlock_console();
...
// 12: #SS
#[no_mangle]
extern "C" fn do_stack_segment(pt_regs: &mut PtRegs, error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn do_general_protection(pt_regs: &mut PtRegs, error_code: isize) {
    unlock_console();
...
// 14: Page fault
#[no_mangle]
extern "C" fn do_page_fault(pt_regs: &mut PtRegs, error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn do_spurious_interrupt_bug(pt_regs: &mut PtRegs, error_code: isize) {
...
#[no_mangle]
extern "C" fn do_coprocessor_error(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 17: Alignment check
#[no_mangle]
extern "C" fn do_alignment_check(pt_regs: &mut PtRegs, error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn do_machine_check(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn do_simd_coprocessor_error(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 20: Virtualization
#[no_mangle]
extern "C" fn do_virtualization(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
// 30: Security
#[no_mangle]
extern "C" fn do_security(pt_regs: &mut PtRegs, _error_code: isize) {
    unlock_console();
...
#[no_mangle]
extern "C" fn enter_from_user_mode() {
    panic!("enter from user mode not supported");
    //crate::halt();
}

#[no_mangle]
extern "C" fn prepare_exit_to_usermode() {
    panic!("prepare exit to user mode not supported");
    //crate::halt();
}

#[no_mangle]
extern "C" fn panic_irq() {
...
#[no_mangle]
extern "C" fn fixup_bad_iret(#[allow(unused_variables)] pt_regs: &mut PtRegs) -> u64 {
    panic!("fixup_bad_iret");
}

#[no_mangle]
extern "C" fn sync_regs(pt_regs: &mut PtRegs) -> u64 {
    panic!("sync_regs:\n{:#?}", pt_regs);
    // Jump to the handler here
    //return 0
}
